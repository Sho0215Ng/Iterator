...
public class IteratorSample1 {
    public static void main(String[] args) {
        ...
        gameListAggregate.add(new Game("ごちうさ", 1000));
        gameListAggregate.add(new Game("キンモザ", 2000));
        gameListAggregate.add(new Game("NEW GAME", 3000));
        gameListAggregate.add(new Game("キルミーベイベー", 4000));
